...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Dynamic):Void {
		...
		openfl.text.Font.registerFont (__ASSET__OPENFL__assets_fonts_leaguespartan_bold_otf);
		openfl.text.Font.registerFont (__ASSET__OPENFL__assets_fonts_panton_blackcaps_otf);
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_fonts_leaguespartan_bold_otf extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_fonts_panton_blackcaps_otf extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_cheese_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_haxejam_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_images_go_here_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_letter_tile_pdn extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_letter_tile_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_title_gradient_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_music_goes_here_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_titlescreen_mp3 extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_music_titlescreen_ogg extends null { }
...
@:keep @:noCompletion #if display private #end class __ASSET__assets_fonts_leaguespartan_bold_otf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/LeagueSpartan-Bold.otf"; name = "League Spartan Bold"; super (); }}
@:keep @:noCompletion #if display private #end class __ASSET__assets_fonts_panton_blackcaps_otf extends lime.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/Panton-BlackCaps.otf"; name = "Panton Black Caps"; super (); }}


#else

@:keep @:expose('__ASSET__assets_fonts_leaguespartan_bold_otf') @:noCompletion #if display private #end class __ASSET__assets_fonts_leaguespartan_bold_otf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/LeagueSpartan-Bold.otf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "League Spartan Bold"; super (); }}
@:keep @:expose('__ASSET__assets_fonts_panton_blackcaps_otf') @:noCompletion #if display private #end class __ASSET__assets_fonts_panton_blackcaps_otf extends lime.text.Font { public function new () { #if !html5 __fontPath = "assets/fonts/Panton-BlackCaps.otf"; #else ascender = null; descender = null; height = null; numGlyphs = null; underlinePosition = null; underlineThickness = null; unitsPerEM = null; #end name = "Panton Black Caps"; super (); }}
...
#if html5
@:keep @:expose('__ASSET__OPENFL__assets_fonts_leaguespartan_bold_otf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_leaguespartan_bold_otf extends openfl.text.Font { public function new () { name = "League Spartan Bold"; super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_fonts_panton_blackcaps_otf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_panton_blackcaps_otf extends openfl.text.Font { public function new () { name = "Panton Black Caps"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}

#else
@:keep @:expose('__ASSET__OPENFL__assets_fonts_leaguespartan_bold_otf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_leaguespartan_bold_otf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/LeagueSpartan-Bold.otf"; name = "League Spartan Bold"; super (); }}
@:keep @:expose('__ASSET__OPENFL__assets_fonts_panton_blackcaps_otf') @:noCompletion #if display private #end class __ASSET__OPENFL__assets_fonts_panton_blackcaps_otf extends openfl.text.Font { public function new () { __fontPath = ManifestResources.rootPath + "assets/fonts/Panton-BlackCaps.otf"; name = "Panton Black Caps"; super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_nokiafc22_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_nokiafc22_ttf ()); super (); }}
@:keep @:expose('__ASSET__OPENFL__flixel_fonts_monsterrat_ttf') @:noCompletion #if display private #end class __ASSET__OPENFL__flixel_fonts_monsterrat_ttf extends openfl.text.Font { public function new () { __fromLimeFont (new __ASSET__flixel_fonts_monsterrat_ttf ()); super (); }}
