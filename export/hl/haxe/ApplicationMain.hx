...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("spelligans", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("spelligans", null, 980, 551);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "spelligans";
		app.meta["name"] = "Spelling Shenanigans";
